...
const config = {
  PORT: 6060, // 启动端口
  ADMIN_GITHUB_LOGIN_NAME: 'Shuai Hou', // 博主的 github 登录的账户名 user
  GITHUB: {
    client_id: '183380ef8eee31d16d0c',
    client_secret: 'ad8e65d1de77df554256d864603cd018dc68d9ec',
...
if (!devMode) {
  ...
  config.EMAIL_NOTICE.transporterConfig.auth = {
    user: '807002995@qq.com', // generated ethereal user
    pass: 'f2bbfe7cf1bcb8253a65c06701fbbbbf8c910be44ecc1a430497d4879db0d71d' // generated ethereal password 授权码 而非 密码
  }
